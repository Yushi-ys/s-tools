import { useNavigate, useLocation, type To, type NavigateOptions } from 'react-router-dom';
...
export interface IUseRouterReturn {
    push: (path: To, state?: RouterState, options?: Omit<NavigateOptions, 'state'>) => void;
    replace: (path: To, state?: RouterState, options?: Omit<NavigateOptions, 'state'>) => void;
    goBack: () => void;
    goForward: () => void;
    pathname: string;
